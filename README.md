...
In sim2real experiments, we used an off-the-shelf a people detector and SLAM algorithm. We transfered a simulated crowd navigation policy to a TurtleBot2i in everyday crowded environments without any real-world finetuning.         

This repo only serves as a reference point for the sim2real transfer of crowd navigation. 
Since there are lots of uncertainties in real-world experiments that may affect performance, **we cannot guarantee that our result is reproducible in your case.** 

<img src="/figures/real.gif" width="260" /> <img src="/figures/3humans.gif" width="260" /> <img src="/figures/4humans.gif" width="260" />  
